...
urlpatterns = [
    ...
    path(
        "category/", views.CategoryListCreateAPIView.as_view(), name="categories_api"
    ...
    path(
        "tag/", views.TagListCreateAPIView.as_view(), name="tags_api"
    ),  # List and create tags
    path(
        "tag/<int:id>/",
        views.TagRetrieveUpdateDestroyAPIView.as_view(),
        name="tag_detail_api",
    ),  # Retrieve, update, delete a tag
    path(
        "blog/", views.BlogListCreateAPIView.as_view(), name="blogs_api"
